...
urlpatterns = patterns('',
    ...
    url(r'^logout/$', 'django.contrib.auth.views.logout', {'next_page': '/epp'}),
    url(r'^accounts/login/$', 'django.contrib.auth.views.login' ),
    url(r'^accounts/logout/$', 'django.contrib.auth.views.logout', {'next_page': '/epp'} ),
    url(r'^admin/logout/$', 'django.contrib.auth.views.logout', {'next_page': '/epp'} ),
